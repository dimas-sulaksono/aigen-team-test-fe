...
import { addPaymentType } from "@/services/paymentType";
import { addSchoolYear } from "@/services/schoolYear";
import React from "react";
import { IoMdClose } from "react-icons/io";

const AddPaymentTypeModal = ({ onClose, dispatch, onRefresh }) => {
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await addPaymentType(name);
          ...
          <div className="mb-4 grid grid-cols-2 gap-4">
            <div className="col-span-2">
              ...
              <Input
                ...
                placeholder="Example : Study Tour"
                required
              />
            </div>
          </div>
