      ...
      <td className="px-4 py-3">
        {!deletedAt && (
          <div className='flex gap-1'>
            ...
            <button onClick={() => { handleDownload(data); }} type="button" className={`px-3 py-1 ${status.toLowerCase() == 'paid' ? 'text-white bg-blue-700 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700' : 'border border-gray-200 pointer-events-none'} dark:focus:ring-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm text-center `}>
              Download
            </button>
          </div>
        )}
